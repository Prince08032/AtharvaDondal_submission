...
const supabase_js_2_39_0_1 = require("https://esm.sh/@supabase/supabase-js@2.39.0");
const corsHeaders = {
...
(0, server_ts_1.serve)(async (req) => {
    ...
    try {
        ...
        const supabase = (0, supabase_js_2_39_0_1.createClient)(supabaseUrl, serviceKey);
        ...
        const { data: fileData, error: downloadError } = await supabase.storage.from("private").download(path);
